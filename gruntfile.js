...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        systemjs: {
            options: {
                baseURL: "app/modules",
                sfx: true,
                configFile: "app/modules/config-system.js"

            },
            dist: {
                files: [{
                    "src": "./app/modules/app.js",
    ...
    grunt.registerTask('build', 'systemjs build', function (minify) {
        var done = this.async();
        ...
        builder.loadConfig('./app/modules/config-system.js').then(function () {
            builder.build('app.js', 'target/outfile.js', {minify: true, mangle: false})
                .then(function () {
    ...
    grunt.registerTask('buildSFX', 'systemjs buildSFX', function (minify) {
        var done = this.async();
        var Builder = require('systemjs-builder'),
            builder = new Builder({
                baseURL: 'app/modules',
        ...
        builder.loadConfig('./app/modules/config-system.js').then(function () {
            builder.buildSFX('app.js', 'target/outfile.js', {minify: true, mangle: false})
                .then(function () {
                    console.log('Build complete');
                    done();
                })
